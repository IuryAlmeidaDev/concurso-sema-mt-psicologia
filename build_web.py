...
vault_dir = r"C:\Users\03573608183\Documents\Obsidian\SEMA-MT-Psicologia"
web_dir = r"C:\Users\03573608183\Documents\Obsidian\SEMA-MT-Psicologia"
...
files_meta = [
    ...
    {"id": "01-fluxo", "title": "📋 Plano de Estudo em 5 Fases", "file": "01 - Fluxo de Estudo.md", "category": "Planejamento"},
    {"id": "02-cronograma", "title": "📅 Cronograma Oficial do Edital", "file": "02 - Cronograma Oficial.md", "category": "Planejamento"},
    ...
    {"id": "05-etica-filosofia", "title": "⚖️ Ética, Filosofia e Legislação MT", "file": "05 - Ética, Filosofia, Atualidades e Legislação.md", "category": "Conhecimentos Gerais"},
    {"id": "06-transversal-gestao", "title": "🏛️ Gestão Pública e Direitos Humanos", "file": "06 - Conteúdos Transversais - Gestão Pública e Direitos Humanos.md", "category": "Conteúdos Transversais"},
    {"id": "07-transversal-ambiental", "title": "🌿 Meio Ambiente, Clima e CAR/PRA", "file": "07 - Conteúdos Transversais - Meio Ambiente e Clima.md", "category": "Conteúdos Transversais"},
    {"id": "08-etica-cfp", "title": "⚖️ Ética Profissional e Resoluções CFP", "file": "08 - Ética Profissional e Resoluções do CFP.md", "category": "Psicologia Específica"},
    {"id": "09-pot-gestao", "title": "🏢 Psicologia Organizacional e Gestão", "file": "09 - Psicologia Organizacional e Gestão de Pessoas.md", "category": "Psicologia Específica"},
    {"id": "10-rs-tde", "title": "🎯 Recrutamento, Seleção e TD&E", "file": "10 - Recrutamento, Seleção e TD&E.md", "category": "Psicologia Específica"},
    {"id": "11-cultura-clima", "title": "🌟 Cultura, Clima e Motivação", "file": "11 - Cultura, Clima e Motivação no Trabalho.md", "category": "Psicologia Específica"},
    {"id": "12-grupos-lideranca", "title": "👥 Psicologia Social e Liderança", "file": "12 - Psicologia Social, Grupos e Liderança.md", "category": "Psicologia Específica"},
    {"id": "13-crises-catastrofes", "title": "🚨 Intervenção em Crises e Catástrofes", "file": "13 - Intervenção em Crises, Emergências e Catástrofes.md", "category": "Saúde Mental no Trabalho"},
    {"id": "14-saude-nrs", "title": "🩺 Saúde do Trabalhador e NRs (1, 5, 17)", "file": "14 - Saúde do Trabalhador e Normas Regulamentadoras.md", "category": "Saúde Mental no Trabalho"},
    {"id": "15-psicopatologia-dejours", "title": "🧠 Dejours, Clínicas e Burnout", "file": "15 - Psicopatologia e Clínicas do Trabalho.md", "category": "Saúde Mental no Trabalho"},
    {"id": "16-assedio-violencia", "title": "🛑 Assédio, Discriminação e Violência", "file": "16 - Assédio, Discriminação e Violência no Trabalho.md", "category": "Saúde Mental no Trabalho"},
    {"id": "17-qvt", "title": "🌿 Qualidade de Vida no Trabalho (QVT)", "file": "17 - Qualidade de Vida e Bem-Estar no Trabalho (QVT).md", "category": "Saúde Mental no Trabalho"},
    {"id": "18-discursiva", "title": "✍️ Prova Discursiva — Temas Quentes", "file": "18 - Prova Discursiva de Psicologia — Estratégia.md", "category": "Discursiva & Banca"},
    {"id": "19-cesgranrio", "title": "🎓 Estratégia Banca Cesgranrio", "file": "19 - Estratégia Banca Cesgranrio para Psicologia.md", "category": "Discursiva & Banca"}
]
...
<head>
  <meta charset="UTF-8">
  <title>Guia de Estudo — SEMA/MT 2026 (Analista em Psicologia)</title>
  ...
  <div class="app">
    ...
    <aside class="sidebar" id="sidebar">
      <div class="sidebar-header">
        ...
        <div class="brand-sub">Analista em Psicologia • Perfil 7</div>
        <div class="search-box">
          <span class="search-icon">🔍</span>
          <input type="text" id="searchInput" placeholder="Pesquisar em Psicologia...">
        </div>
      </div>
    ...
    <div class="main">
      <header class="top-bar">
        ...
        <a href="https://github.com/IuryAlmeidaDev/concurso-sema-mt-psicologia" target="_blank" class="github-link">
          🐙 Repositório GitHub
        </a>
      </header>
      ...
      <main class="content-container">
        <article class="markdown-body" id="contentArea">
          Carregando conteúdo de Psicologia...
        </article>
...
print("Web app for Psicologia compiled successfully. Size:", len(html_template), "bytes")
